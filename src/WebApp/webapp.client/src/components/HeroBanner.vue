...
<template>
  <div class="relative mx-auto">
    <img width="1400" height="800" class="object-cover w-full h-[420px] lg:h-[560px] xl:h-[640px]"
      src="/images/hero.jpg" alt="Hero" loading="eager" sizes="sm:100vw md:1400px" fetchpriority="high" preload
      placeholder-class="blur-xl" />
    <div
      class="container mx-auto absolute inset-0 flex flex-col items-start justify-center bg-gradient-to-l from-gray-200 md:bg-none">
      ...
      <RouterLink :to="{ name: 'products' }">Show Now</RouterLink>
    </div>
  </div>
</template>
