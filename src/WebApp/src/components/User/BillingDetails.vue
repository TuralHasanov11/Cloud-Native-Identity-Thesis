...
<template>
    <div class="grid w-full gap-4 lg:grid-cols-2">
        <div class="w-full">
            ...
            <InputText id="first-name" disabled v-model="user.name" placeholder="John" autocomplete="given-name"
                type="text" required />
        </div>
        ...
        <div class="w-full">
            ...
            <InputText id="city" disabled v-model="address.city" placeholder="New York" autocomplete="locality"
                type="text" required />
        </div>
        ...
        <div class="w-full">
            ...
            <InputText id="zip" disabled v-model="address.zipCode" placeholder="10001" autocomplete="postal-code"
                type="text" required />
        </div>
    </div>
</template>
