...
public class ShipOrderCommandTests : IClassFixture<OrderingFactory>
{
    private readonly IMediator _mediator;
    private readonly OrderingDbContext _dbContext;

    public ShipOrderCommandTests(OrderingFactory factory)
    {
    ...
    [Fact]
    public async Task Handle_ShouldShipOrder()
    {
        // Arrange
        ...
        Assert.Equal(OrderStatus.Shipped, updatedOrder?.OrderStatus);
    }
    ...
    public async Task Handle_ShouldReturnNotFound_WhenOrderDoesNotExist()
    {
        ...
        var command = new ShipOrderCommand(Guid.CreateVersion7());
